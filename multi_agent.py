...
class MultiAgent(Agent):
  ...
  def save_weights(self, filepaths, overwrite=False):
    ...
    """
    for name in filepaths:
      self.inner_agents[name].save_weights(filepaths[name] + '_' + str(np.random.randint(0, 100000000)))
  ...
  def fit(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
          ...
          nb_max_episode_steps=None, interim_filenames=None):
      ...
      self.training = True
      for name in self.inner_agents:
        self.inner_agents[name].training = True
      self.interim_filenames = interim_filenames
  ...
  def test(self, env, nb_episodes=1, action_repetition=1, callbacks=None, visualize=True,
      ...
      self.step = 0
      for name in self.inner_agents:
        self.inner_agents[name].step = 0
        self.inner_agents[name].training = False
